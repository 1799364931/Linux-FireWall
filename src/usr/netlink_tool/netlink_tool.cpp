        ...
        case CMD_LIST_RATE_LIMIT_REPLY: {
            ...
            if (attrs[ATTR_RATE_LIMIT_LIST]) {
                ...
                if (len < (int)sizeof(uint32_t)) {
                    std::cout << "Error: invalid rate limit list message" << std::endl;
                    break;
                }
                ...
                for (uint32_t i = 0; i < rule_count; i++) {
                    ...
                    std::cout << "  Rate: " << rule_msg->refill_rate << " pps\n";
                    ...
                    std::cout << "  Status: " << (rule_msg->enabled ? "enabled" : "disabled") << "\n";
                    std::cout << "  Packets Allowed: " << rule_msg->packets_allowed << "\n";
                    std::cout << "  Packets Dropped: " << rule_msg->packets_dropped << "\n";
